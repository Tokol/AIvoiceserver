...
class Agent extends lifecycle_1.AgentHooks {
     ...
     */
    asTool(options) {
        const { toolName, toolDescription, customOutputExtractor, needsApproval, runConfig, runOptions, resumeState, isEnabled, onStream, } = options;
        ...
        const baseTool = (0, tool_1.tool)({
            ...
            execute: async (data, context, details) => {
                ...
                const resumeContext = resumeContextStrategy === 'preferSerialized'
                    ? undefined
                    : runOptions?.context instanceof runContext_1.RunContext
                        ? runOptions.context
                        : typeof runOptions?.context !== 'undefined'
                            ? new runContext_1.RunContext(runOptions.context)
                            : context;
                let runInput = data.input;
